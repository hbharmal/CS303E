...
def main():
	...
	print (startVertex)
	delEdgeFrom, delEdgeTo = (inFile.readline().strip().split())
	...
	print("\nTesting Delete Edge from " + delEdgeFrom + "to " + delEdgeTo)
	cities.deleteEdge(delEdgeFrom, delEdgeTo)
	...
	print("\nTesting Delete Vertex of " + delVertex)
