...
#  Description: Code to find the value of PI
...
def main():
	...
	for i in range(0,len(values)):
		print("num = ", '{0: <10}'.format(str(values[i])), "Calculated PI = ", format(computePI(values[i]),'.6f'), "  Difference = ", format(difference(values[i]),'+.6f'))
